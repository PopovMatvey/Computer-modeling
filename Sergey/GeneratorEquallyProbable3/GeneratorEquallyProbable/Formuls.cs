...
namespace GeneratorEquallyProbable
{
  public static class Formuls
  {
    ...
    /// <returns></returns>
    public static double GetHi2Equally(List<int> parM, int parCountNumbers, List<double> parP)
    {
      double sum = 0;
      double a;
    ...
    /// <param name="parP">Вероятность вхождения в интервал</param>
    /// <returns></returns>
    public static double GetHi2Exponential(List<int> parM, int parCountNumbers, List<double> parP)
    {
      double sum = 0;
      double a;
      for (int i = 0; i < parM.Count(); i++)
